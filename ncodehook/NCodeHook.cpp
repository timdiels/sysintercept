	...
	forceAbsJmp_(false)
{
	...
	if (trampolineBuffer_ == NULL) throw runtime_error("Unable to allocate trampoline memory!");
...
{
	if (freeTrampolines_.empty()) throw runtime_error("No trampoline space available!");
